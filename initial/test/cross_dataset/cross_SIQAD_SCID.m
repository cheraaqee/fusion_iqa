...
for the_parameter = 1:14
    ...
    cost = cazama(the_parameter, 1);
    gamma = cazama(the_parameter, 2);
    ...
    spear_results_qc(1, the_parameter) = corr(predict_score, label_test,'type','Spearman');
    [spear_results_qc(2, the_parameter), spear_results_qc(3, the_parameter)]=...
        PearsonLC(predict_score, label_test);
    spear_results_qc(4, the_parameter) = corr(predict_score, label_test, 'type', 'Kendall');
end
save('cross_p_SIQAD_SCID.mat', 'spear_results_qc');